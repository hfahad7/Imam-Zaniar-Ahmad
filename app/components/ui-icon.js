const icons = {
  ...
  phoneMessage: (
    <>
      <path d="M16.8 14.7v2a1.5 1.5 0 0 1-1.7 1.5 14 14 0 0 1-6.1-2.2 13.7 13.7 0 0 1-4.2-4.2 14 14 0 0 1-2.2-6.1A1.5 1.5 0 0 1 4.1 4h2a1.5 1.5 0 0 1 1.5 1.3c.1.7.3 1.4.5 2a1.5 1.5 0 0 1-.4 1.5l-.8.8a11 11 0 0 0 4.2 4.2l.8-.8a1.5 1.5 0 0 1 1.5-.4c.6.2 1.3.4 2 .5a1.5 1.5 0 0 1 1.4 1.6Z" />
      <path d="M13 4h5a3 3 0 0 1 3 3v3a3 3 0 0 1-3 3h-1l-3 2v-2" />
    </>
  ),
  instagram: (
    <>
  ...
  form: (
    <>
      ...
      <path d="M15 3v5h5M9 12h7M9 16h4" />
      <path d="m14.5 17.5 1.2 1.2 2.8-3" />
    </>
  ),
  podium: (
    <>
      <path d="M5 10h14l-2 9H7zM12 19v3M8 22h8" />
      <path d="M8 7h8M10 4h4" />
    </>
  ),
  headphones: (
    <>
